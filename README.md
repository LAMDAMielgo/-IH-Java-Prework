...
Write a method that returns the largest integer in the list. You can assume that the ist has at least one element.
...
[More info](https://my.ironhack.com/lms/courses/course-v1:IRONHACK+JAVAPREWORK+SANTANDER/units/dbf4af61a31a4ce4aad70cb4f65a7452)